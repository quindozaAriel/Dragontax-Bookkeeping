...
<div class="section__inclusion">
    <div class="container">
        <div class="row inclusion__margin">
            ...
            <div class="col-md-6 col-lg-7  col-xl-7  d-none d-sm-none d-md-block d-lg-block d-xl-block">
                <div class="inclusion__image" data-aos="zoom-in-up">
                    <div class="inclusion__image__bg"></div>
                    <div class="inclusion__image__fg--a" data-tilt></div>
                </div>
        ...
        <div class="row inclusion__margin">
            <div class="col-md-6 col-lg-7 col-xl-7 mb-4 mb-md-0 mb-lg-0 mb-xl-0">
                <div class="inclusion__image" data-aos="zoom-in-up">
                    <div class="inclusion__image__bg"></div>
                    <div class="inclusion__image__fg--b" data-tilt></div>
                </div>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-5">
                <div class="inclusion">
        ...
        <div class="row inclusion__margin">
            <div class="col-12 mb-4 d-block d-sm-block d-md-none d-lg-none d-xl-none">
                <div class="inclusion__image" data-aos="zoom-in-up">
                    <div class="inclusion__image__bg"></div>
                    <div class="inclusion__image__fg--c" data-tilt></div>
                </div>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-5">
                <div class="inclusion">
        ...
        <div class="row inclusion__margin">
            <div class="col-md-6 col-lg-7 col-xl-7 mb-4 mb-md-0 mb-lg-0 mb-xl-0">
                <div class="inclusion__image" data-aos="zoom-in-up">
                    <div class="inclusion__image__bg"></div>
                    <div class="inclusion__image__fg--d" data-tilt></div>
                </div>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-5">
                <div class="inclusion">
